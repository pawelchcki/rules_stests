(define-library (otel implementation python-sdk-v1.44.0)
  (export python-sdk-v1.44
          python-trace-api python-span-api python-trace-sdk
          python-status-api python-attributes-api
          ...
          python-textmap-api python-composite-propagator)
  (import (scheme base))
  (begin
...
; Span and its set_status operation.
(define python-span-api "https://github.com/open-telemetry/opentelemetry-python/blob/53a5a40c9604583c501bcf13970a635f00e62df4/opentelemetry-api/src/opentelemetry/trace/span.py")
; StatusCode, which enumerates UNSET, OK and ERROR.
...
; The process-global propagator getter and setter.
...
; The TextMapPropagator interface, fields and getter contract.
(define python-textmap-api "https://github.com/open-telemetry/opentelemetry-python/blob/53a5a40c9604583c501bcf13970a635f00e62df4/opentelemetry-api/src/opentelemetry/propagators/textmap.py")
; CompositePropagator, which composes several TextMapPropagators.
(define python-composite-propagator "https://github.com/open-telemetry/opentelemetry-python/blob/53a5a40c9604583c501bcf13970a635f00e62df4/opentelemetry-api/src/opentelemetry/propagators/composite.py")
  ))
