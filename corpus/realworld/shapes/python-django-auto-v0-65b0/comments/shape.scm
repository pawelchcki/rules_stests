(define-library (realworld shape python-django-auto-v0-65b0 comments)
...
(define scenario-shape
  (traces
    ...
    (repeat 2 (trace (coverage 'complete)
        (unordered
          (span (scope "opentelemetry.instrumentation.django") (kind 'server) (status 'unset) (name (exact "DELETE api/articles/<slug>/comments/<comment_id>")) (http-status 204)
            (children (unordered
