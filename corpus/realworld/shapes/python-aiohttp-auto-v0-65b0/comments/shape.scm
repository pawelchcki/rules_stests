(define-library (realworld shape python-aiohttp-auto-v0-65b0 comments)
...
(define scenario-shape
  (traces
    ...
    (repeat 2 (trace (coverage 'complete)
        (unordered
          (span (scope "opentelemetry.instrumentation.aiohttp_server") (kind 'server) (status 'unset) (name (exact "DELETE /api/articles/{slug}/comments/{comment_id}")) (http-status 204)
            (children (unordered
              (span (scope "opentelemetry.instrumentation.sqlalchemy") (kind 'client) (status 'unset) (name (prefix-suffix "DELETE /" "realworld.sqlite3")) (http-status 'absent))
