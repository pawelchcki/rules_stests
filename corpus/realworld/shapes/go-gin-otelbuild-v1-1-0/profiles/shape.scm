(define-library (realworld shape go-gin-otelbuild-v1-1-0 profiles)
...
(define scenario-shape
  (traces
    ...
    (repeat 3 (trace (coverage 'complete)
        (unordered
          (span (scope "go.opentelemetry.io/otelc/instrumentation/net/http") (kind 'server) (status 'unset) (name (exact "GET /api/profiles/:username")) (http-status 200)))))
    (trace (coverage 'complete)
      (unordered
