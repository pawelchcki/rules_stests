...
(define scenario-shape
  (traces
    ...
    (trace (coverage 'complete)
      (unordered
        (span (scope "OpenTelemetry::Instrumentation::Rack") (kind 'server) (status 'unset) (name (exact "GET /api/articles/feed")) (http-status 'absent))))
    (trace (coverage 'complete)
      (unordered
    ...
    (trace (coverage 'complete)
      (unordered
        (span (scope "OpenTelemetry::Instrumentation::Rack") (kind 'server) (status 'unset) (name (exact "PUT /api/articles/:slug")) (http-status 'absent))))
    (repeat 2 (trace (coverage 'complete)
        (unordered
          (span (scope "OpenTelemetry::Instrumentation::Rack") (kind 'server) (status 'unset) (name (exact "PUT /api/articles/:slug")) (http-status 'absent)
            (children (unordered
