(define-library (realworld shape go-gin-otelbuild-v1-1-0 articles)
...
(define scenario-shape
  (traces
    ...
    (repeat 35 (trace (coverage 'complete)
        (unordered
    ...
    (repeat 146 (trace (coverage 'complete)
        (unordered
    ...
    (repeat 6 (trace (coverage 'complete)
        (unordered
          (span (scope "go.opentelemetry.io/otelc/instrumentation/net/http") (kind 'server) (status 'unset) (name (exact "GET /api/articles")) (http-status 200)))))
    (repeat 3 (trace (coverage 'complete)
        (unordered
          (span (scope "go.opentelemetry.io/otelc/instrumentation/net/http") (kind 'server) (status 'unset) (name (exact "GET /api/articles/:slug")) (http-status 200)))))
    (trace (coverage 'complete)
      (unordered
    ...
    (repeat 3 (trace (coverage 'complete)
        (unordered
          (span (scope "go.opentelemetry.io/otelc/instrumentation/net/http") (kind 'server) (status 'unset) (name (exact "PUT /api/articles/:slug")) (http-status 200)))))
    (trace (coverage 'complete)
      (unordered
        (span (scope "go.opentelemetry.io/otelc/instrumentation/net/http") (kind 'server) (status 'unset) (name (exact "PUT /api/articles/:slug")) (http-status 422))))))
  ))
