(define-library (realworld shape go-gin-otelbuild-v1-1-0 favorites)
...
(define scenario-shape
  (traces
    ...
    (repeat 81 (trace (coverage 'complete)
        (unordered
    ...
    (trace (coverage 'complete)
      (unordered
        (span (scope "go.opentelemetry.io/otelc/instrumentation/net/http") (kind 'server) (status 'unset) (name (exact "DELETE /api/articles/:slug/favorite")) (http-status 200))))
    ...
    (trace (coverage 'complete)
      (unordered
        (span (scope "go.opentelemetry.io/otelc/instrumentation/net/http") (kind 'server) (status 'unset) (name (exact "POST /api/articles/:slug/favorite")) (http-status 200))))
    (trace (coverage 'complete)
      (unordered
