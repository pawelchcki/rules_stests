(define-library (realworld shape go-gin-otelbuild-v1-1-0 comments)
...
(define scenario-shape
  (traces
    ...
    (repeat 30 (trace (coverage 'complete)
        (unordered
    ...
    (repeat 110 (trace (coverage 'complete)
        (unordered
    ...
    (repeat 2 (trace (coverage 'complete)
        (unordered
          (span (scope "go.opentelemetry.io/otelc/instrumentation/net/http") (kind 'server) (status 'unset) (name (exact "DELETE /api/articles/:slug/comments/:id")) (http-status 204)))))
