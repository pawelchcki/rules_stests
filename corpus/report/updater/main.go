...
func main() {
	...
	flag.StringVar(&matrixPath, "matrix", "corpus/report/data/spec-compliance-matrix.md", "matrix snapshot output")
	flag.StringVar(&metadataPath, "metadata", "corpus/report/data/catalog.json", "catalog metadata to update")
	flag.Parse()
