(define-library (datadog realworld shape python-aiohttp-datadog-v4-14-0-v05 feed)
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/feed-article-1-rules-stests-<workload>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles/{slug}")
                ("http.status_code" "204")
                ("http.url" "http://<endpoint>/api/articles/feed-article-2-rules-stests-<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "python")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
            ...
            (children
              (
                (
                  ...
                  (name "sqlite.query")
                  (type "sql")
                  (resource "INSERT INTO follows (follower_id, followed_id) VALUES (?, ?) ON CONFLICT DO NOTHING")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
