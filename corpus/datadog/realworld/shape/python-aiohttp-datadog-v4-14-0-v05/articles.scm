(define-library (datadog realworld shape python-aiohttp-datadog-v4-14-0-v05 articles)
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/test-article-rules-stests-<workload>")
            ...
            (children
              (
                (
                  ...
                  (name "sqlite.query")
                  (type "sql")
                  (resource "DELETE FROM article_tags WHERE article_tags.article_id = ?")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                ...
                (
                  ...
                  (name "sqlite.query")
                  (type "sql")
                  (resource "UPDATE articles SET updated_at=? WHERE articles.id = ?")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
