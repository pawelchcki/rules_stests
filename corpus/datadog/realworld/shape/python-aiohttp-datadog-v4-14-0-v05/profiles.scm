(define-library (datadog realworld shape python-aiohttp-datadog-v4-14-0-v05 profiles)
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/profiles/celeb_rules_stests_<workload>/follow")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.status_code" "200")
                ("http.url" "http://<endpoint>/api/profiles/celeb_rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "python")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
