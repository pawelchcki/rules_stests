(define-library (datadog realworld shape python-django-datadog-v4-14-0-v05 favorites)
          ...
          (
            ...
            (meta
              (
                ...
                ("django.user.name" "fav_rules_stests_<workload>")
          ...
          (
            ...
            (meta
              (
                ...
                ("django.user.is_authenticated" "True")
                ("django.user.name" "fav_rules_stests_<workload>")
                ("django.view" "api-1.0.0:favorite")
                ("env" "test")
                ("http.method" "DELETE")
                                                                        ...
                                                                        (children
                                                                          (
                                                                            ...
                                                                            (
                                                                              ...
                                                                              (name "sqlite.query")
                                                                              (type "sql")
                                                                              (resource "DELETE FROM \"articles_article_favorites\" WHERE (\"articles_article_favorites\".\"article_id\" = %s AND \"articles_article_favorites\".\"user_id\" IN (%s))")
                                                                              (parent-kind "child")
                                                                              (error 0)
                                                                              (meta
                                                                                (
                                                                            ...
                                                                            (
                                                                              ...
                                                                              (name "sqlite.query")
                                                                              (type "sql")
                                                                              (resource "SELECT \"accounts_user\".\"id\", \"accounts_user\".\"password\", \"accounts_user\".\"last_login\", \"accounts_user\".\"is_superuser\", \"accounts_user\".\"is_staff\", \"accounts_user\".\"is_active\", \"accounts_user\".\"date_joined\", \"accounts_user\".\"email\", \"accounts_user\".\"username\", \"accounts_user\".\"bio\", \"accounts_user\".\"image\" FROM \"accounts_user\" INNER JOIN \"articles_article_favorites\" ON (\"accounts_user\".\"id\" = \"articles_article_favorites\".\"user_id\") WHERE (\"articles_article_favorites\".\"article_id\" = %s AND \"accounts_user\".\"id\" = %s) LIMIT 21")
                                                                              (parent-kind "child")
                                                                              (error 0)
                                                                              (meta
                                                                                (
                                                                        ...
                                                                        (children
                                                                          (
                                                                            ...
                                                                            (
                                                                              ...
                                                                              (name "sqlite.query")
                                                                              (type "sql")
                                                                              (resource "SELECT COUNT(*) FROM (SELECT \"articles_article\".\"id\" AS \"col1\" FROM \"articles_article\" LEFT OUTER JOIN \"articles_article_favorites\" ON (\"articles_article\".\"id\" = \"articles_article_favorites\".\"article_id\") INNER JOIN \"articles_article_favorites\" T4 ON (\"articles_article\".\"id\" = T4.\"article_id\") INNER JOIN \"accounts_user\" T5 ON (T4.\"user_id\" = T5.\"id\") WHERE T5.\"username\" = %s GROUP BY 1) subquery")
                                                                              (parent-kind "child")
                                                                              (error 0)
                                                                              (meta
                                                                                (
                                                                        ...
                                                                        (children
                                                                          (
                                                                            ...
                                                                            (
                                                                              ...
                                                                              (name "sqlite.query")
                                                                              (type "sql")
                                                                              (resource "INSERT OR IGNORE INTO \"articles_article_favorites\" (\"article_id\", \"user_id\") VALUES (%s, %s)")
                                                                              (parent-kind "child")
                                                                              (error 0)
                                                                              (meta
                                                                                (
                                                                            ...
                                                                            (
                                                                              ...
                                                                              (name "sqlite.query")
                                                                              (type "sql")
                                                                              (resource "SELECT %s AS \"a\" FROM \"accounts_user\" INNER JOIN \"articles_article_favorites\" ON (\"accounts_user\".\"id\" = \"articles_article_favorites\".\"user_id\") WHERE (\"articles_article_favorites\".\"article_id\" = %s AND \"accounts_user\".\"id\" = %s) LIMIT 1")
                                                                              (parent-kind "child")
                                                                              (error 0)
                                                                              (meta
                                                                                (
