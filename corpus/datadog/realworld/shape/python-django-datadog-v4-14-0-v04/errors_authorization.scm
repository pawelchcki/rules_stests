(define-library (datadog realworld shape python-django-datadog-v4-14-0-v04 errors_authorization)
          ...
          (
            ...
            (meta
              (
                ...
                ("django.user.name" "authz_a_rules_stests_<workload>")
          ...
          (
            ...
            (meta
              (
                ...
                ("django.user.id" "2")
                ("django.user.is_authenticated" "True")
                ("django.user.name" "authz_b_rules_stests_<workload>")
                ("django.view" "api-1.0.0:retrieve")
                ("env" "test")
                ("http.method" "DELETE")
                ("http.route" "api/articles/<slug>")
                                                                        ...
                                                                        (children
                                                                          (
                                                                            ...
                                                                            (
                                                                              ...
                                                                              (name "sqlite.query")
                                                                              (type "sql")
                                                                              (resource "SELECT \"articles_article\".\"id\", \"articles_article\".\"author_id\", \"articles_article\".\"title\", \"articles_article\".\"summary\", \"articles_article\".\"content\", \"articles_article\".\"created\", \"articles_article\".\"updated\", \"articles_article\".\"slug\" FROM \"articles_article\" WHERE \"articles_article\".\"id\" = %s LIMIT 21")
                                                                              (parent-kind "child")
                                                                              (error 0)
                                                                              (meta
                                                                                (
