(define-library (datadog realworld shape python-django-datadog-v4-14-0-v04 errors_articles)
          ...
          (
            ...
            (meta
              (
                ...
                ("django.user.name" "ea_art_rules_stests_<workload>")
                ("django.view" "api-1.0.0:retrieve")
                ("env" "test")
                ("http.method" "DELETE")
                ("http.route" "api/articles/<slug>")
                ("http.status_code" "204")
                ("http.url" "http://<endpoint>/api/articles/dup-title-rules_stests_<workload>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/unknown-slug-rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "python")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/some-slug")
                ("http.useragent" "hurl/8.0.1")
                ("language" "python")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.status_code" "404")
                ("http.url" "http://<endpoint>/api/articles/unknown-slug-rules_stests_<workload>/favorite")
                ("http.useragent" "hurl/8.0.1")
                ("language" "python")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "api/articles/<slug>/favorite")
                ("http.status_code" "401")
                ("http.url" "http://<endpoint>/api/articles/some-slug/favorite")
                ("http.useragent" "hurl/8.0.1")
                ("language" "python")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
