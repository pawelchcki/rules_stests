(define-library (datadog realworld shape python-django-datadog-v4-14-0-v04 errors_auth)
                                                                            ...
                                                                            (
                                                                              ...
                                                                              (meta
                                                                                (
                                                                                  ...
                                                                                  ("db.system" "sqlite")
                                                                                  ("env" "test")
                                                                                  ("error.message" "UNIQUE constraint failed: accounts_user.email")
                                                                            ...
                                                                            (
                                                                              ...
                                                                              (meta
                                                                                (
                                                                                  ...
                                                                                  ("db.system" "sqlite")
                                                                                  ("env" "test")
                                                                                  ("error.message" "UNIQUE constraint failed: accounts_user.username")
                                                                                  ("error.stack" "<validated-stack>")
                                                                                  ("error.type" "sqlite3.IntegrityError")
                                                                                  ("span.kind" "client")))
                                                                              (metrics
          ...
          (
            ...
            (meta
              (
                ...
                ("django.user.name" "ea_dup_rules_stests_<workload>")
                ("django.view" "api-1.0.0:get_user")
                ("env" "test")
                ("http.method" "PUT")
                ("http.route" "api/user")
