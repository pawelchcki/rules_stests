(define-library (datadog realworld shape python-django-datadog-v4-14-0-v04 feed)
          ...
          (
            ...
            (meta
              (
                ...
                ("django.user.name" "feedc_rules_stests_<workload>")
          ...
          (
            ...
            (meta
              (
                ...
                ("django.user.id" "1")
                ("django.user.is_authenticated" "True")
                ("django.user.name" "feedm_rules_stests_<workload>")
                ("django.view" "api-1.0.0:follow_profile")
                ("env" "test")
                ("http.method" "DELETE")
