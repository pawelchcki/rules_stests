(define-library (datadog realworld shape python-aiohttp-datadog-v4-14-0-v04 favorites)
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/favorite-article-rules-stests-<workload>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/favorite-article-rules-stests-<workload>/favorite")
                ("http.useragent" "hurl/8.0.1")
                ("language" "python")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
            ...
            (children
              (
                (
                  ...
                  (name "sqlite.query")
                  (type "sql")
                  (resource "DELETE FROM favorites WHERE favorites.user_id = ? AND favorites.article_id = ?")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
            ...
            (children
              (
                (
                  ...
                  (name "sqlite.query")
                  (type "sql")
                  (resource "INSERT INTO favorites (user_id, article_id) VALUES (?, ?) ON CONFLICT DO NOTHING")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
