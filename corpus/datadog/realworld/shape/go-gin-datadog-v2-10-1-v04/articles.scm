(define-library (datadog realworld shape go-gin-datadog-v2-10-1-v04 articles)
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/test-article-rules_stests_<workload>")
            ...
            (children
              (
                ...
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT * FROM `favorite_models` WHERE (favorite_id IN (?) AND favorite_by_id = ?) AND `favorite_models`.`deleted_at` IS NULL")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                ...
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT COUNT(DISTINCT(`article_models`.`id`)) FROM `article_models` WHERE `article_models`.`deleted_at` IS NULL")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                  ...
                  (children
                    (
                      (
                        ...
                        (name "gorm.query")
                        (type "sql")
                        (resource "SELECT DISTINCT article_models.* FROM `article_models` WHERE `article_models`.`deleted_at` IS NULL ORDER BY article_models.created_at DESC, article_models.id DESC LIMIT 20")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                        ...
                        (children
                          (
                            ...
                            (
                              ...
                              (name "gorm.query")
                              (type "sql")
                              (resource "SELECT * FROM `tag_models` WHERE `tag_models`.`id` IN (?,?) AND `tag_models`.`deleted_at` IS NULL")
                              (parent-kind "child")
                              (error 0)
                              (meta
                                (
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles")
                ("http.status_code" "200")
                ("http.url" "http://<endpoint>/api/articles?author=art_rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "go")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles")
                ("http.status_code" "200")
                ("http.url" "http://<endpoint>/api/articles?tag=d_rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "go")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
            ...
            (children
              (
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT COUNT(DISTINCT(`article_models`.`id`)) FROM `article_models` JOIN article_tags ON article_tags.article_model_id = article_models.id JOIN tag_models ON tag_models.id = article_tags.tag_model_id AND tag_models.deleted_at IS NULL WHERE tag_models.tag = ? AND `article_models`.`deleted_at` IS NULL")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                  ...
                  (children
                    (
                      (
                        ...
                        (name "gorm.query")
                        (type "sql")
                        (resource "SELECT DISTINCT article_models.* FROM `article_models` JOIN article_tags ON article_tags.article_model_id = article_models.id JOIN tag_models ON tag_models.id = article_tags.tag_model_id AND tag_models.deleted_at IS NULL WHERE tag_models.tag = ? AND `article_models`.`deleted_at` IS NULL ORDER BY article_models.created_at DESC, article_models.id DESC LIMIT 20")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
      ...
      (roots
        (
          (
            ...
            (name "http.request")
            (type "web")
            (resource "GET /api/articles/:slug")
            (parent-kind "root")
            (error 0)
            (meta
              (
            ...
            (children
              (
                  ...
                  (children
                    (
                      (
                        ...
                        (name "gorm.create")
                        (type "sql")
                        (resource "INSERT INTO `article_tags` (`article_model_id`,`tag_model_id`) VALUES (?,?),(?,?) ON CONFLICT DO NOTHING")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                      ...
                      (
                        ...
                        (name "gorm.create")
                        (type "sql")
                        (resource "INSERT INTO `tag_models` (`created_at`,`updated_at`,`deleted_at`,`tag`,`id`) VALUES (?,?,?,?,?),(?,?,?,?,?) ON CONFLICT DO NOTHING RETURNING `id`")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                ...
                (
                  ...
                  (name "gorm.create")
                  (type "sql")
                  (resource "INSERT INTO `tag_models` (`created_at`,`updated_at`,`deleted_at`,`tag`) VALUES (?,?,?,?) RETURNING `id`")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                ...
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT * FROM `tag_models` WHERE tag IN (?,?) AND `tag_models`.`deleted_at` IS NULL")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
      ...
      (roots
        (
          (
            ...
            (name "http.request")
            (type "web")
            (resource "PUT /api/articles/:slug")
            (parent-kind "root")
            (error 0)
            (meta
              (
            ...
            (children
              (
                ...
                (
                  ...
                  (name "gorm.delete")
                  (type "sql")
                  (resource "DELETE FROM `article_tags` WHERE `article_tags`.`article_model_id` = ?")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                ...
                (
                  ...
                  (name "gorm.update")
                  (type "sql")
                  (resource "UPDATE `article_models` SET `author_id`=?,`updated_at`=? WHERE `article_models`.`deleted_at` IS NULL AND `id` = ?")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                ...
                (
                  ...
                  (name "gorm.update")
                  (type "sql")
                  (resource "UPDATE `article_models` SET `updated_at`=? WHERE `article_models`.`deleted_at` IS NULL AND `id` = ?")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
            ...
            (children
              (
                ...
                (
                  ...
                  (name "gorm.update")
                  (type "sql")
                  (resource "UPDATE `article_models` SET `author_id`=?,`body`=?,`updated_at`=? WHERE `article_models`.`deleted_at` IS NULL AND `id` = ?")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
