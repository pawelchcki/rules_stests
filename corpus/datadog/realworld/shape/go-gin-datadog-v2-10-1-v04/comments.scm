(define-library (datadog realworld shape go-gin-datadog-v2-10-1-v04 comments)
            ...
            (children
              (
                ...
                (
                  ...
                  (name "gorm.delete")
                  (type "sql")
                  (resource "UPDATE `comment_models` SET `deleted_at`=? WHERE `comment_models`.`id` = ? AND `comment_models`.`deleted_at` IS NULL")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
