          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/feed-article-1-rules_stests_<workload>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles/:slug")
                ("http.status_code" "204")
                ("http.url" "http://<endpoint>/api/articles/feed-article-2-rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "go")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/profiles/feedc_rules_stests_<workload>/follow")
                ("http.useragent" "hurl/8.0.1")
                ("language" "go")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
            ...
            (children
              (
                (
                  ...
                  (name "gorm.delete")
                  (type "sql")
                  (resource "DELETE FROM `follow_models` WHERE following_id = ? AND followed_by_id = ?")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
      ...
      (roots
        (
          (
            ...
            (name "http.request")
            (type "web")
            (resource "GET /api/articles/feed")
            (parent-kind "root")
            (error 0)
            (meta
              (
                ...
                ("http.status_code" "200")
                ("http.url" "http://<endpoint>/api/articles/feed")
                ("http.useragent" "hurl/8.0.1")
                ("language" "go")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
            ...
            (children
              (
                ...
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT * FROM `article_models` WHERE author_id IN (?) AND `article_models`.`deleted_at` IS NULL ORDER BY created_at DESC, id DESC LIMIT 20")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                  ...
                  (children
                    (
                      (
                        ...
                        (name "gorm.query")
                        (type "sql")
                        (resource "SELECT * FROM `article_tags` WHERE `article_tags`.`article_model_id` IN (?,?)")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                ...
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT * FROM `article_user_models` WHERE user_model_id IN (?) AND `article_user_models`.`deleted_at` IS NULL")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                ...
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT * FROM `follow_models` WHERE `follow_models`.`followed_by_id` = ? AND `follow_models`.`deleted_at` IS NULL")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                ...
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT count(*) FROM `article_models` WHERE author_id IN (?) AND `article_models`.`deleted_at` IS NULL")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles/feed")
                ("http.status_code" "200")
                ("http.url" "http://<endpoint>/api/articles/feed?limit=1")
                ("http.useragent" "hurl/8.0.1")
                ("language" "go")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
            ...
            (children
              (
                ...
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT * FROM `article_models` WHERE author_id IN (?) AND `article_models`.`deleted_at` IS NULL ORDER BY created_at DESC, id DESC LIMIT 1")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles/feed")
                ("http.status_code" "200")
                ("http.url" "http://<endpoint>/api/articles/feed?limit=1&offset=1")
                ("http.useragent" "hurl/8.0.1")
                ("language" "go")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
            ...
            (children
              (
                ...
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT * FROM `article_models` WHERE author_id IN (?) AND `article_models`.`deleted_at` IS NULL ORDER BY created_at DESC, id DESC LIMIT 1 OFFSET 1")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
            ...
            (children
              (
                (
                  ...
                  (name "gorm.create")
                  (type "sql")
                  (resource "INSERT INTO `follow_models` (`created_at`,`updated_at`,`deleted_at`,`following_id`,`followed_by_id`) VALUES (?,?,?,?,?) ON CONFLICT (`following_id`,`followed_by_id`) DO NOTHING RETURNING `id`")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
