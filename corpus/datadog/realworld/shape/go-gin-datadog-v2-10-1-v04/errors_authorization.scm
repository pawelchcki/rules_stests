          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/authz-article-rules_stests_<workload>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.status_code" "403")
                ("http.url" "http://<endpoint>/api/articles/authz-article-rules_stests_<workload>/comments/1")
                ("http.useragent" "hurl/8.0.1")
                ("language" "go")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
                  ...
                  (children
                    (
                      (
                        ...
                        (name "gorm.query")
                        (type "sql")
                        (resource "SELECT * FROM `article_models` WHERE `article_models`.`id` = ? AND `article_models`.`deleted_at` IS NULL")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/authz-article-rules_stests_<workload>/comments")
                ("http.useragent" "hurl/8.0.1")
                ("language" "go")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
            ...
            (children
              (
                ...
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT * FROM `comment_models` WHERE `comment_models`.`article_id` = ? AND `comment_models`.`deleted_at` IS NULL")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
            ...
            (children
              (
                (
                  ...
                  (name "gorm.create")
                  (type "sql")
                  (resource "INSERT INTO `article_models` (`created_at`,`updated_at`,`deleted_at`,`slug`,`title`,`description`,`body`,`author_id`,`id`) VALUES (?,?,?,?,?,?,?,?,?) ON CONFLICT DO NOTHING RETURNING `id`")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                ...
                (
                  ...
                  (name "gorm.create")
                  (type "sql")
                  (resource "INSERT INTO `comment_models` (`created_at`,`updated_at`,`deleted_at`,`article_id`,`author_id`,`body`) VALUES (?,?,?,?,?,?) RETURNING `id`")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
