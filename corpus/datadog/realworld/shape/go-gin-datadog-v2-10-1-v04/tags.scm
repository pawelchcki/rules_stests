(define-library (datadog realworld shape go-gin-datadog-v2-10-1-v04 tags)
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/tag-article-rules_stests_<workload>")
            ...
            (children
              (
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT * FROM `tag_models` WHERE `tag_models`.`deleted_at` IS NULL")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
