          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/favorite-article-rules_stests_<workload>")
      ...
      (roots
        (
          (
            ...
            (name "http.request")
            (type "web")
            (resource "DELETE /api/articles/:slug/favorite")
            (parent-kind "root")
            (error 0)
            (meta
              (
                ...
                ("http.url" "http://<endpoint>/api/articles/favorite-article-rules_stests_<workload>/favorite")
                ("http.useragent" "hurl/8.0.1")
                ("language" "go")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
            ...
            (children
              (
                ...
                (
                  ...
                  (name "gorm.delete")
                  (type "sql")
                  (resource "DELETE FROM `favorite_models` WHERE favorite_id = ? AND favorite_by_id = ?")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
          ...
          (
            ...
            (meta
              (
                ...
                ("http.status_code" "200")
                ("http.url" "http://<endpoint>/api/articles?favorited=fav_rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "go")
                ("runtime-id" "<runtime-id>")
                ("span.kind" "server")
            ...
            (children
              (
                ...
                (
                  ...
                  (name "gorm.query")
                  (type "sql")
                  (resource "SELECT COUNT(DISTINCT(`article_models`.`id`)) FROM `article_models` JOIN favorite_models AS favorites ON favorites.favorite_id = article_models.id AND favorites.deleted_at IS NULL JOIN article_user_models AS favoriters ON favoriters.id = favorites.favorite_by_id AND favoriters.deleted_at IS NULL JOIN user_models AS favoriter_users ON favoriter_users.id = favoriters.user_model_id WHERE favoriter_users.username = ? AND `article_models`.`deleted_at` IS NULL")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
                  ...
                  (children
                    (
                      (
                        ...
                        (name "gorm.query")
                        (type "sql")
                        (resource "SELECT DISTINCT article_models.* FROM `article_models` JOIN favorite_models AS favorites ON favorites.favorite_id = article_models.id AND favorites.deleted_at IS NULL JOIN article_user_models AS favoriters ON favoriters.id = favorites.favorite_by_id AND favoriters.deleted_at IS NULL JOIN user_models AS favoriter_users ON favoriter_users.id = favoriters.user_model_id WHERE favoriter_users.username = ? AND `article_models`.`deleted_at` IS NULL ORDER BY article_models.created_at DESC, article_models.id DESC LIMIT 20")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
      ...
      (roots
        (
          (
            ...
            (name "http.request")
            (type "web")
            (resource "POST /api/articles/:slug/favorite")
            (parent-kind "root")
            (error 0)
            (meta
              (
            ...
            (children
              (
                ...
                (
                  ...
                  (name "gorm.create")
                  (type "sql")
                  (resource "INSERT INTO `favorite_models` (`created_at`,`updated_at`,`deleted_at`,`favorite_id`,`favorite_by_id`) VALUES (?,?,?,?,?) ON CONFLICT (`favorite_id`,`favorite_by_id`) DO NOTHING RETURNING `id`")
                  (parent-kind "child")
                  (error 0)
                  (meta
                    (
