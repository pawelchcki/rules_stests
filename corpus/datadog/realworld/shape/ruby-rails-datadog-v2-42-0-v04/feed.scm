(define-library (datadog realworld shape ruby-rails-datadog-v2-42-0-v04 feed)
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles/feed-article-1-rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles/:slug")
                ("http.status_code" "204")
                ("http.url" "/api/articles/feed-article-2-rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
      ...
      (roots
        (
          (
            ...
            (name "rack.request")
            (type "web")
            (resource "ArticlesController#feed")
            (parent-kind "root")
            (error 0)
            (meta
              (
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT COUNT(*) FROM \"articles\" WHERE \"articles\".\"user_id\" IN (SELECT \"users\".\"id\" FROM \"users\" INNER JOIN \"follows\" ON \"users\".\"id\" = \"follows\".\"followed_id\" WHERE \"follows\".\"follower_id\" = ?)")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT \"article_tags\".* FROM \"article_tags\" WHERE \"article_tags\".\"article_id\" IN (?, ?)")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT \"articles\".* FROM \"articles\" WHERE \"articles\".\"user_id\" IN (SELECT \"users\".\"id\" FROM \"users\" INNER JOIN \"follows\" ON \"users\".\"id\" = \"follows\".\"followed_id\" WHERE \"follows\".\"follower_id\" = ?) ORDER BY \"articles\".\"created_at\" DESC, \"articles\".\"id\" DESC LIMIT ? OFFSET ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT \"favorites\".* FROM \"favorites\" WHERE \"favorites\".\"article_id\" IN (?, ?)")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles/feed")
                ("http.status_code" "200")
                ("http.url" "/api/articles/feed?limit")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles/feed")
                ("http.status_code" "200")
                ("http.url" "/api/articles/feed?limit&offset")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
      ...
      (roots
        (
          (
            ...
            (name "rack.request")
            (type "web")
            (resource "ProfilesController#follow")
            (parent-kind "root")
            (error 0)
            (meta
              (
                ...
                ("http.status_code" "200")
                ("http.url" "/api/profiles/feedc_rules_stests_<workload>/follow")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "INSERT INTO \"follows\" (\"follower_id\", \"followed_id\") VALUES (?, ?) RETURNING \"id\"")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT 1 AS one FROM \"follows\" WHERE \"follows\".\"followed_id\" = ? AND \"follows\".\"follower_id\" = ? LIMIT ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT \"follows\".* FROM \"follows\" WHERE \"follows\".\"follower_id\" = ? AND \"follows\".\"followed_id\" = ? LIMIT ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
      ...
      (roots
        (
          (
            ...
            (name "rack.request")
            (type "web")
            (resource "ProfilesController#unfollow")
            (parent-kind "root")
            (error 0)
            (meta
              (
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "DELETE FROM \"follows\" WHERE \"follows\".\"follower_id\" = ? AND \"follows\".\"followed_id\" = ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
