          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles/pagination-1-rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles/:slug")
                ("http.status_code" "204")
                ("http.url" "/api/articles/pagination-2-rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles?author&limit")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles")
                ("http.status_code" "200")
                ("http.url" "/api/articles?author&limit&offset")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
