(define-library (datadog realworld shape ruby-rails-datadog-v2-42-0-v04 errors_authorization)
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles/authz-article-rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (meta
                          (
                            ("active_record.instantiation.class_name" "Comment")
                            ("component" "active_record")
                            ("env" "test")
                            ("operation" "instantiation")
                            ("version" "1")))
      ...
      (roots
        (
          (
            ...
            (name "rack.request")
            (type "web")
            (resource "CommentsController#create")
            (parent-kind "root")
            (error 0)
            (meta
              (
                ...
                ("http.status_code" "201")
                ("http.url" "/api/articles/authz-article-rules_stests_<workload>/comments")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
                ...
                (
                  ...
                  (meta
                    (
                      ...
                      ("operation" "controller")
                      ("rails.route.action" "create")
                      ("rails.route.controller" "CommentsController")
                      ("version" "1")))
                  (metrics
                    (
                      ("_dd.measured" 1.0)
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "INSERT INTO \"comments\" (\"article_id\", \"user_id\", \"body\", \"created_at\", \"updated_at\") VALUES (?, ?, ?, ?, ?) RETURNING \"id\"")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
      ...
      (roots
        (
          (
            ...
            (name "rack.request")
            (type "web")
            (resource "CommentsController#destroy")
            (parent-kind "root")
            (error 0)
            (meta
              (
                ...
                ("http.status_code" "403")
                ("http.url" "/api/articles/authz-article-rules_stests_<workload>/comments/1")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT \"comments\".* FROM \"comments\" WHERE \"comments\".\"article_id\" = ? AND \"comments\".\"id\" = ? LIMIT ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
      ...
      (roots
        (
          (
            ...
            (name "rack.request")
            (type "web")
            (resource "CommentsController#index")
            (parent-kind "root")
            (error 0)
            (meta
              (
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT \"comments\".* FROM \"comments\" WHERE \"comments\".\"article_id\" = ? ORDER BY \"comments\".\"created_at\" ASC, \"comments\".\"id\" ASC")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
