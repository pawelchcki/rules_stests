                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "UPDATE \"users\" SET \"password_digest\" = ?, \"updated_at\" = ? WHERE \"users\".\"id\" = ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT 1 AS one FROM \"users\" WHERE \"users\".\"email\" IS NULL AND \"users\".\"id\" != ? LIMIT ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT 1 AS one FROM \"users\" WHERE \"users\".\"username\" IS NULL AND \"users\".\"id\" != ? LIMIT ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
