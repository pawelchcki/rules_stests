(define-library (datadog realworld shape ruby-rails-datadog-v2-42-0-v04 favorites)
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles/favorite-article-rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles/favorite-article-rules_stests_<workload>/favorite")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "INSERT INTO \"favorites\" (\"article_id\", \"user_id\") VALUES (?, ?) RETURNING \"id\"")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT 1 AS one FROM \"favorites\" WHERE \"favorites\".\"user_id\" = ? AND \"favorites\".\"article_id\" = ? LIMIT ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT \"favorites\".* FROM \"favorites\" WHERE \"favorites\".\"article_id\" = ? AND \"favorites\".\"user_id\" = ? LIMIT ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles")
                ("http.status_code" "200")
                ("http.url" "/api/articles?favorited")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (meta
                          (
                            ("active_record.instantiation.class_name" "Favorite")
                            ("component" "active_record")
                            ("env" "test")
                            ("operation" "instantiation")
                            ("version" "1")))
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT COUNT(DISTINCT \"articles\".\"id\") FROM \"articles\" WHERE \"articles\".\"id\" IN (SELECT \"favorites\".\"article_id\" FROM \"favorites\" WHERE \"favorites\".\"user_id\" IN (SELECT \"users\".\"id\" FROM \"users\" WHERE \"users\".\"username\" = ?))")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "SELECT DISTINCT \"articles\".* FROM \"articles\" WHERE \"articles\".\"id\" IN (SELECT \"favorites\".\"article_id\" FROM \"favorites\" WHERE \"favorites\".\"user_id\" IN (SELECT \"users\".\"id\" FROM \"users\" WHERE \"users\".\"username\" = ?)) ORDER BY \"articles\".\"created_at\" DESC, \"articles\".\"id\" DESC LIMIT ? OFFSET ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "DELETE FROM \"favorites\" WHERE \"favorites\".\"article_id\" = ? AND \"favorites\".\"user_id\" = ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
