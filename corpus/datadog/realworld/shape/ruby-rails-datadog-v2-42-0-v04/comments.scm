          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles/comment-article-rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.status_code" "201")
                ("http.url" "/api/articles/comment-article-rules_stests_<workload>/comments")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.status_code" "204")
                ("http.url" "/api/articles/comment-article-rules_stests_<workload>/comments/1")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles/:slug/comments/:comment_id")
                ("http.status_code" "204")
                ("http.url" "/api/articles/comment-article-rules_stests_<workload>/comments/2")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
