(define-library (datadog realworld shape ruby-rails-datadog-v2-42-0-v04 errors_comments)
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles/err-comment-art-rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles/unknown-slug-rules_stests_<workload>/comments")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles/err-comment-art-rules_stests_<workload>/comments")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.status_code" "404")
                ("http.url" "/api/articles/err-comment-art-rules_stests_<workload>/comments/99999")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles/:slug/comments/:comment_id")
                ("http.status_code" "404")
                ("http.url" "/api/articles/unknown-slug-rules_stests_<workload>/comments/99999")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles/some-slug/comments/1")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
          ...
          (
            ...
            (meta
              (
                ...
                ("http.route" "/api/articles/:slug/comments")
                ("http.status_code" "401")
                ("http.url" "/api/articles/some-slug/comments")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
