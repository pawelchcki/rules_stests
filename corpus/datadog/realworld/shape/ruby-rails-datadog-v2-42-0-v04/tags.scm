(define-library (datadog realworld shape ruby-rails-datadog-v2-42-0-v04 tags)
          ...
          (
            ...
            (meta
              (
                ...
                ("http.url" "/api/articles/tag-article-rules_stests_<workload>")
                ("http.useragent" "hurl/8.0.1")
                ("language" "ruby")
                ("operation" "request")
                ("runtime-id" "<runtime-id>")
                  ...
                  (children
                    (
                      ...
                      (
                        ...
                        (name "sqlite.query")
                        (type "sql")
                        (resource "DELETE FROM \"article_tags\" WHERE \"article_tags\".\"id\" = ?")
                        (parent-kind "child")
                        (error 0)
                        (meta
                          (
