...
var preferredBindings = map[string]string{
	...
	"traces.span.attribute-collection-size-limit":                       "span/attribute-limit",
	"traces.sampling.spanlimits":                                        "sampling/span-limits",
	"traces.sampling.attribute-limits":                                  "sampling/attribute-limits",
	"traces.spancontext.isvalid":                                        "span-context/is-valid",
	"traces.spancontext.isremote":                                       "span-context/is-remote",
	"traces.span-attributes.unicode-support-for-keys-and-string-values": "span/unicode-attribute",
	...
	"metrics.the-metrics-sdk-samples-exemplars-from-measurements":       "metric/exemplar-sampling",
	"metrics.the-metrics-sdk-supports-tracebased-exemplar-filter":       "metric/exemplar-filter-trace-based",
	"metrics.exemplars-contain-the-associated-trace-id-and-span-id-of-the-active-span-in-the-context-when-the-measurement-was-taken": "metric/exemplar-trace-context",
	"metrics.exemplars-contain-the-timestamp-when-the-measurement-was-taken":                                                         "metric/exemplar-timestamp",
	"metrics.metric-sdk-supports-per-timeseries-cumulative-start-timestamps":                                                         "metric/cumulative-start-timestamps",
	"metrics.the-metrics-reader-implementation-supports-configuring-the-default-temporality-on-the-basis-of-instrument-kind":         "metric/reader-temporality-by-instrument-kind",
	"exporters.otlp.metric-exporter-configurable-temporality-preference":                                                             "exporter/otlp-metric-temporality-preference",
