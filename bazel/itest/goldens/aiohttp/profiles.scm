(define-library (realworld detail python-aiohttp-auto-v0-65b0 profiles)
...
(define expected-implementation-buckets
  '((1 sqlalchemy client unset (prefix-suffix "DELETE /" "realworld.sqlite3") child absent)
    ...
    (18 sqlalchemy client unset (prefix-suffix "SELECT /" "realworld.sqlite3") child absent)
    ...
    (18 sqlite client unset (exact "SELECT") root absent)))
  ))
