...
((requests (
 ...
 (spans (
  ...
  ((scope "trace.scope") (trace-id "8c1e0a5b6d2f47398a4b0c7e1d5f3a92") (span-id "999999999999999a")
   (parent-span-id "00f067aa0ba902b7") (parent-class external) (parent-valid #t) (trace-state "") (name "GET /api/tags") (kind 2)
   (start 5) (end 6) (attributes ()) (events ())
   (status-code 0) (status-message "") (flags 769))
  ((scope "trace.scope") (trace-id "b3f7d21c9e6a48059c7d2e8f4a1b6035") (span-id "aaaaaaaaaaaaaaa1")
   (parent-span-id "00f067aa0ba902b7") (parent-class external) (parent-valid #t) (trace-state "") (name "GET /api/tags") (kind 2)
   (start 5) (end 6) (attributes ()) (events ())
   (status-code 0) (status-message "") (flags 769))
