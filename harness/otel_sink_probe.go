...
(validate-probe (read))`)
	...
	featureFailures := []struct {
		...
		{"metrics.counter-instrument-is-supported", strings.Replace(syntheticFeatureCapture, `(data-type sum) (aggregation-temporality delta) (monotonic #t)`, `(data-type summary) (aggregation-temporality delta) (monotonic #t)`, 1)},
		{"metrics.updowncounter-instrument-is-supported", strings.Replace(syntheticFeatureCapture, `(data-type sum) (aggregation-temporality cumulative) (monotonic #f)`, `(data-type summary) (aggregation-temporality cumulative) (monotonic #f)`, 1)},
