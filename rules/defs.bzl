...
load("//rules:realworld_app.bzl", _REALWORLD_APPS = "REALWORLD_APPS", _otel_injection = "otel_injection", _otlp_env = "otlp_env", _python_auto_injection = "python_auto_injection", _realworld_app_suite = "realworld_app_suite", _ruby_auto_injection = "ruby_auto_injection")
