...
load("//rules:otel_profile.bzl", _TelemetryProfileInfo = "TelemetryProfileInfo", _datadog_realworld_profile = "datadog_realworld_profile", _otel_realworld_profile = "otel_realworld_profile", _otel_report_manifest = "otel_report_manifest", _otel_standard_registry = "otel_standard_registry")
load("//rules:realworld_app.bzl", _datadog_env = "datadog_env", _datadog_ruby_injection = "datadog_ruby_injection", _datadog_python_injection = "datadog_python_injection", _instrumentation_injection = "instrumentation_injection", _REALWORLD_APPS = "REALWORLD_APPS", _otel_injection = "otel_injection", _otlp_env = "otlp_env", _python_auto_injection = "python_auto_injection", _otel_variant = "otel_variant", _realworld_app_suite = "realworld_app_suite", _ruby_auto_injection = "ruby_auto_injection")
...
TelemetryProfileInfo = _TelemetryProfileInfo
datadog_realworld_profile = _datadog_realworld_profile
